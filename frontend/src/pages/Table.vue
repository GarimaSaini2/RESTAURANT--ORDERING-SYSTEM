    ...
    <section class="order-section">
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                ...
                <h3>02 Model Town,Bhupindra Road, Patiala </h3>
            </div>
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="input-box">
                    <iframe class="map"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3443.1758357644235!2d76.37568107515048!3d30.34595227477315!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391029002bfb3b1f%3A0xd6054cc2569fdf68!2sTic%20tacs-%20the%20infinity%20fun!5e0!3m2!1sen!2sin!4v1718176331623!5m2!1sen!2sin"
                 loading="lazy"></iframe>
                </div>
            </div>
    ...
    methods: {
        ...
        checkForm: function () {
            ...
            if (!this.orderObj.phone) {
                ...
                if (!this.orderObj.phone.startsWith('94')) {
                    this.errorObj.phoneErr.push('Phone numbers must start with 94');
                }
